...
public class CrawlerDBConfig {
    ...
    private Logger logger = LoggerFactory.getLogger(CrawlerDBConfig.class);
    static final String PACKAGE = "com.crawler.*.dao";
    static final String MAPPER_LOCATION = "classpath*:mybatis/crawler/**/*.xml";
    static final String DOMAIN_PACKAGE = "com.crawler.*.domain";
